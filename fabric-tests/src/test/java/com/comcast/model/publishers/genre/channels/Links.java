...
private String publishers_genre_channels_all;
...
public String getPublishers_genre_channels_all ()
{
 return publishers_genre_channels_all;
}

public void setPublishers_genre_channels_all (String publishers_genre_channels_all)
{
 this.publishers_genre_channels_all = publishers_genre_channels_all;
}

@Override
public String toString() {
	return "Links [publishers_genre_channels_all="
			+ publishers_genre_channels_all + ", self=" + self + ", imageUri="
			+ imageUri + ", sharelink=" + sharelink + ", logoImage="
			+ logoImage + ", userVideoDetails=" + userVideoDetails
			+ ", templateImage=" + templateImage + ", channel=" + channel
			+ ", publisher=" + publisher + ", defaultImage=" + defaultImage
			+ ", cellImage=" + cellImage + ", channelSubscriptionStatus="
			+ channelSubscriptionStatus + ", genre=" + genre
			+ ", channelsAllVideos=" + channelsAllVideos + ", channelVideos="
			+ channelVideos + ", paginateShowsAndVideosTemplate="
