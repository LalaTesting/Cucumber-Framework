 ...
 * Description: This test script verifies user is navigating back to home page from Browse shows page by 
 on bottom watchable logo.
 *Created on 28-October-2016 
 *Last updated on 28-October-2016
 * 
 */

public class VerifyNavigatingToHomePageFromBrowseShowsPageClickingOnBottomWatchableLogo
		extends BaseTest {
	...
	public void Step06_ClickOnBottomWatchableLogo() throws Exception {
		...
		// Click on bottom watchable logo
		homePage = browseShowsPage.clickOnBottomWatchableLogo();
