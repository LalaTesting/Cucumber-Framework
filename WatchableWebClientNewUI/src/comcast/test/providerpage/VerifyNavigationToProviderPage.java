...
/**
 * 
 * @author Manoj.Paragen Description: This test script verifies the navigation
 *         to provider page from GET TO KNOW THE SHOW section from home page.
 *         Created on 19-October-2016 Last updated on 19-October-2016
 * 
 */
