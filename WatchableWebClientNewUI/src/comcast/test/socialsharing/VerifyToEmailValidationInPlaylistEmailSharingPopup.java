 ...
 * Description: This test script verifies to email address validation in playlist email sharing popup 
 * when try to send by entering invalid email address in to email address field.
 * Created on 08-December-2016 
 * Last updated on 08-December-2016
 * 
 */

public class VerifyToEmailValidationInPlaylistEmailSharingPopup extends BaseTest {
	...
	/**
	 * Enter invalid email address in to email address and click on Send button.
	 * 
	 * */
	@Test(description = "Step 10:Enter invalid email address in to email address and click on Send button.", priority = 10)
	public void Step10_EnterInvalidToEmail() throws Exception {

		// Enter invalid email in To field
		String invalidEmail = TextProp.getProperty("invalidemail");
		watchPage.enterToEmailInPlaylistShowSharingPopup(invalidEmail);
		...
		Assert.assertTrue(
				CustomFun.isElementPresent(
						...
						driver),
				"Error message in not displayed for to email address field when email id is invalid.");

		log.info("Error message is displayed for to email address field when email id is invalid.\n");
		Reporter.log("<p>Error message is displayed for to email address field when email id is invalid.");
