 ...
 * Description: This test script verifies from email address is auto populated in show email sharing popup window with 
...
public class VerifyAutomPopulationOfFromEmailInShowEmailSharingPopup extends
		BaseTest {
	...
	/**
	 * Verify from email address is present in show email sharing popup.
	 */
	...
	public void Step09_VerifyFromEmailInPopup() throws Exception {
		...
		Reporter.log("<p>From email address is show in playlist email sharing popup.");
