 ...
 * Description: This test script verifies send functionality of playlist email sharing by entering valid to email address.
 * Created on 09-December-2016 
 * Last updated on 09-December-2016
 * 
 */

public class VerifyPlaylistEmailSharingSendFunctionality extends BaseTest {
	 ...
	 * 
	 * */
	@Test(description = "Step 9:Enter invalid email address in to email address and click on Send button.", priority = 9)
	public void Step09_EnterValidToEmail() throws Exception {
	 ...
	 */
	@Test(description = "Step 10: Click on close button from pop-up message.", priority = 10)
	public void Step10_ClickOnCloseButton() throws Exception {

		// Click on close button.
		watchPage.clickOnCloseButtonFromPlaylistSharingPopup();

		// Verifying pop-up message window is closed
		Assert.assertFalse(
				driver.findElement(
						By.xpath(ObjRepoProp
								.getProperty("watchPageEmailPlaylistPopUp_XPATH")))
