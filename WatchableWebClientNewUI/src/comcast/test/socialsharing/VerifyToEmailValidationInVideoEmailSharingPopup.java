 ...
 * Description: This test script verifies to email address validation in video email sharing popup 
...
public class VerifyToEmailValidationInVideoEmailSharingPopup extends BaseTest {
	 ...
	 * 
	 * */
	@Test(description = "Step 8:Enter invalid email address in to email address and click on Send button.", priority = 8)
	public void Step08_EnterInvalidToEmail() throws Exception {

		// Enter invalid email in To field
		String invalidEmail = TextProp.getProperty("invalidemail");
		watchPage.enterToEmailInVideoSharingPopup(invalidEmail);
