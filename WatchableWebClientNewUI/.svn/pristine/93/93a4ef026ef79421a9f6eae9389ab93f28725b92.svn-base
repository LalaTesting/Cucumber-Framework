 ...
 * Description: This test script verifies user is navigating back to home page from provider page by clicking on 
 * bottom watchable logo. 
 * Created on 20-October-2016 
 * Last updated on 20-October-2016
 * 
 */

public class VerifyClickOnBottomWatchableLogoFromProviderPageNavigatesHomePage
		extends BaseTest {
	...
	public void Step07_ClickOnBottomWatchableLogo() throws Exception {
		...
		// Click on bottom watchable logo
		homePage = providerPage.clickOnBottomWatchableLogo();
