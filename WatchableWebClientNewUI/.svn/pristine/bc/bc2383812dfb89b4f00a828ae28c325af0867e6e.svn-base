 ...
 * Description: This test script verifies send functionality of show email sharing by entering valid to email address.
 * Created on 09-December-2016 
 * Last updated on 09-December-2016
 * 
 */

public class VerifyShowEmailSharingSendFunctionality extends BaseTest {
