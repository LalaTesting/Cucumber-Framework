 ...
 * Description: This test script verifies validation in playlist email sharing popup when try to send by keeping 
...
public class VerifyValidationInPlaylistEmailSharingPopup extends BaseTest {
