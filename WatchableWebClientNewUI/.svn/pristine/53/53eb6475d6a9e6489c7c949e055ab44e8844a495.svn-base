 ...
 * Description: This test script verifies navigating to my shows page on clicking My Shows menu from header after login.
 * Created on 14-November-2016 
 * Last updated on 14-November-2016
 * 
 */

public class VerifyNavigatingToMyShowsPageAfterLogin extends BaseTest {
