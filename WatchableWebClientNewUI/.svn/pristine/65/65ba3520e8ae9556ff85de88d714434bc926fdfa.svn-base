 ...
 * Description: This test script verifies user can share playlist from show email sharing popup window without message.
 * Created on 09-December-2016 
 * Last updated on 09-December-2016
 * 
 */

public class VerifyMessageInShowEmailSharingPopup extends BaseTest {
