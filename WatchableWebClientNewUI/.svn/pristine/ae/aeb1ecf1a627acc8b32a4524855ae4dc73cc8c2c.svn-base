 ...
 * Description: This test script verifies user is navigating back to home page from show page by clicking on top watchable logo. 
 * Created on 14-October-2016 
 * Last updated on 14-October-2016
 * 
 */

public class VerifyNavigatingToHomePageFromShowPageClickingOnTopWatchableLogo extends BaseTest {
	...
	public void Step04_VerfiyHeaderWatchableLogo() throws Exception {
		...
		Assert.assertTrue(CustomFun.isElementPresent(
				By.xpath(ObjRepoProp.getProperty("showPageHeaderWatchableLogo_XPATH")),
				driver), "Watchable logo is not present in the header of the page.");
	...
	public void Step05_ClickOnHeaderWatchableLogo() throws Exception {
		...
		// Click on header watchable logo
		homePage = showPage.clickOnHeaderWatchableLogo();
