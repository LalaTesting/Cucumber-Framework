 ...
 * Description: This test script verifies page title is displaying for provider page and title content. 
...
public class VerifyProviderPageTitle extends BaseTest {
	 ...
	 */
	@Test(description = "Step 6: Verify title is displaying for Provider page.", priority = 6)
	public void Step06_VerifyProviderPageTitle() throws Exception {
		...
		Assert.assertNotNull(pageTitle,
				"Page title is not present for Provider page");

		log.info("Page title is present for Provider page.\n");
		Reporter.log("<p>Page title is present for Provider page");

		log.info("Provider Page title displayed is: " + pageTitle + " \n");
		Reporter.log("<p>Provider Page title displayed is: " + pageTitle);
